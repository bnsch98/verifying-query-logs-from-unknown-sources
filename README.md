...
```
cd existing_repo
git remote add origin https://git.webis.de/code-teaching/theses/thesis-schneg.git
git branch -M main
...
- [ ] [Set up project integrations](https://git.webis.de/code-teaching/theses/thesis-schneg/-/settings/integrations)
