...
| `query-quality`                                           | [Classify queries in terms of their grammatical quality.](https://huggingface.co/nvidia/quality-classifier-deberta)                                                                         | 
| `query-domain`                                            | [Classify queries into a domain taxonomy.](https://huggingface.co/nvidia/domain-classifier)                                                                                        | 
| `query-nsfw`                                              | [Determine if the query is *safe for work* or *not safe for work*](https://huggingface.co/eliasalbouzidi/distilbert-nsfw-text-classifier), that is, if it contains inappropriate language.                      | 
