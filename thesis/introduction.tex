...
\begin{itemize}
    ...
    \item \textbf{Embedding-based:} We create vector embeddings from queries and investigate similarities between the different query logs in the latent space. Clustering algorithms are applied to the embeddings and the resulting clusters are compared. 
