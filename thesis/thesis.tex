...
\usepackage{pgfplots} % for pgf plots (addded 12/14/2024)
\usepackage{import} % for pgf plots (addded 12/14/2024)
\pgfplotsset{compat=1.18} % for pgf plots (addded 12/14/2024)
\usepackage{lmodern} % for pgf plots (addded 12/14/2024)
\def\mathdefault#1{#1} % for pgf plots (addded 12/14/2024)
\everymath=\expandafter{\the\everymath\displaystyle} % for pgf plots (addded 12/14/2024)

\ifdefined\pdftexversion\else  % non-pdftex case. % for pgf plots (addded 12/14/2024)
  \usepackage{fontspec} % for pgf plots (addded 12/14/2024)
\fi % for pgf plots (addded 12/14/2024)
\makeatletter\@ifpackageloaded{underscore}{}{\usepackage[strings]{underscore}}\makeatother % for pgf plots (addded 12/14/2024)
